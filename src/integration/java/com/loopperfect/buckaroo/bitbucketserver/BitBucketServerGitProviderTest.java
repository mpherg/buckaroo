...
public final class BitBucketServerGitProviderTest {
    ...
    public void test() throws Exception {
        ...
        final RecipeSource recipeSource = GitProviderRecipeSource.of(
            fs,
            BitBucketServerGitProvider.of());

        final SettableFuture<Boolean> future = SettableFuture.create();

        recipeSource.fetch(RecipeIdentifier.of("bitbucketserver", "njlr", "hello-buckaroo"))
            .result()
            .subscribe(recipe -> {
